            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                  <img src="<?php echo base_url();?>image/img.jpg" alt="">John Doe
                  ...
                  <table class="table table-striped responsive-utilities jambo_table bulk_action">
                    <thead>
                      <tr class="headings">
                        ...
                        <th class="column-title">NPM </th>
                        <th class="column-title">NAMA CALAS </th>
                        <th class="column-title">NILAI TEORI (C1) </th>
                        <th class="column-title">NILAI PRAKTEK (C2) </th>
                        <th class="column-title">NILAI WAWANCARA (C3) </th>
                        <th class="column-title">NILAI PRESENTASI (C4) </th>
                        <th class="column-title">HASIL AWAL </th>
                        <th class="column-title">Vi </th>
                        <th class="column-title">Hasil Awal </th>
